...
include "ImageCropUtil.class.php";
$imageCropUtil = new ImageCropUtil("2.png", 1, "300", "500", "5.png");   //使用图片缩放功能
$imageCropUtil = new ImageCropUtil("2.png", 2, "0,0", "50,50", "5.png"); //使用图片裁剪功能
$imageCropUtil = new ImageCropUtil("2.png", 3, "1.png", "0", "5.png");   //使用加图片水印功能
$imageCropUtil->outimage();

*/

class Util_ImageCropUtil {
